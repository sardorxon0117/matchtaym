...
export default function RoyxatdanOtishPage() {
  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col px-4 py-16 sm:px-6">
      ...
      <h1 className="mb-1 font-heading text-xl font-semibold text-ink">Ro&apos;yxatdan o&apos;tish</h1>
      <p className="mb-6 text-sm text-ink-soft">Izoh qoldirish uchun hisob yarating.</p>
